...
namespace Aetherverse::Services::Rendering::AppGUI
{
    struct RenderDevice final : Noesis::RenderDevice
    {
        ...
        (
            ...
            bgfx::ViewId viewID = Views::AppGUIView
        );
    ...
    private:
        ...
        Uniform S_Pattern_ { "s_pattern", UniformType::Sampler };
        Uniform S_Ramps_ { "s_ramps", UniformType::Sampler };
        Uniform S_Image_ { "s_image", UniformType::Sampler };
        Uniform S_Glyphs_ { "s_glyphs", UniformType::Sampler };
        Uniform S_Shadow_ { "s_shadow", UniformType::Sampler };

        // vertex shader uniforms
        Uniform U_CBuffer1_VS_ { "u_cbuffer1_vs", UniformType::Vec4, 16 / Vec4Size_ };

        // fragment shader uniforms
        Uniform U_CBuffer0_FS_ { "u_cbuffer0_fs", UniformType::Vec4, 8 / Vec4Size_ };
        Uniform U_CBuffer1_FS_ { "u_cbuffer1_fs", UniformType::Vec4, 128 / Vec4Size_ };
